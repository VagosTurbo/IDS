...
DROP PROCEDURE UpdatePersonEmail;
...
--     CONSTRAINT Stav_check CHECK (Stav IN ('Pripraveno k vyzdvihnuti', 'Ceka na dodani dilu', 'Servisovano')), -- NAHRAZENO TRIGGEREM
...
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Karosář', 1);
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Lakování', 2);
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Mechanik', 4);
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Elektrikář', 5);
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Elektrikář', 6);
INSERT INTO Automechanik (Specializace, Osoba) VALUES ('Karosář', 7);

INSERT INTO Zakaznik (Adresa, ICO, Osoba) VALUES ('Ulice 1, Brno', '87654321', 3);
INSERT INTO Zakaznik (Adresa, ICO, Osoba) VALUES ('Ulice 5, Olomouc', '34567890', 6);
INSERT INTO Zakaznik (Adresa, ICO, Osoba) VALUES ('Ulice 6, Liberec', '45678901', 7);
INSERT INTO Zakaznik (Adresa, ICO, Osoba) VALUES ('Ulice 3, Ostrava', '12345678', 4);
INSERT INTO Zakaznik (Adresa, ICO, Osoba) VALUES ('Ulice 4, Plzeň', '23456789', 5);
...
-- 5 - Seznam zaneprazdnenych automechanikov
...
-- 6 - Seznam vsech zakazniku z Brna
SELECT *
FROM Zakazka
WHERE Zakaznik IN (
    SELECT Zakaznik_Id
...
-- 7 - Seznam vsech exterierovych automechanikov
SELECT *
FROM Automechanik
...
-- 8 - Seznam vsech aut zakaznika Eva Dolezalova
...
-- Trigger1 pro kontrolu stavu při vytváření nové zakázky
...
-- Trigger2 pro aktualizaci stavu faktury po zaplacení
...
-- UPDATE Faktura
-- SET Zaplaceno = 'TRUE'
-- WHERE Cislo_faktury = 1;


-- Procedura1 pro výpočet celkové ceny faktury
...
GRANT CREATE ANY VIEW TO XSUCHA18;
...
-- AS
-- SELECT z.*, zk.*, a.*
-- FROM XSEMAN06.Zakazka z
-- JOIN XSEMAN06.Zakaznik zk ON z.Zakaznik = zk.Zakaznik_Id
-- JOIN XSEMAN06.Auto a ON z.Auto = a.VIN;
--
--
--
-- -- prava k materialized view
-- GRANT ALL ON mv_zakazka_full to XSEMAN06;

-- SELECT * FROM XSUCHA18.mv_zakazka_full;
...
-- Dotaz na celkový počet zakázek podle stavu
SELECT Stav, COUNT(*) AS Pocet_zakazek
FROM Zakazka
GROUP BY Stav;

CREATE INDEX idx_zakazka_stav ON Zakazka(Stav);
